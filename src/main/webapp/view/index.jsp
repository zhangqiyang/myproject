			  ...
			  <li><a href="javascript:void(0)" target="mainframe"
               ...
               <li><a href="javascript:void(0)" target="mainframe"
                   ...
                   <li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
                            <li><a href="view/edumanage/transaction/transaction_list.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 班级事务
							</a></li>
                            <li><a href="view/student/evaluationinfo/evaluationinfo_list.action" target="mainframe"> <i
						...
						<ul class="submenu">
                            <li><a href="view/student/student/student_list.action" target="mainframe"> <i
